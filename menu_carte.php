...
<?php
	echo '
		...
		<img src="image/icone/affiche_monstre-icone.png" alt="Afficher/Cacher les monstres" title="Afficher/Cacher les monstres" style="cursor:pointer;" onclick="cache_monstre=!cache_monstre;show_only=\'\';deplacement(\'centre\', cache_monstre, affiche_royaume, show_only);cache_monstre ? this.src=\'\image/icone/cache_monstre-icone.png\' : this.src=\'\image/icone/affiche_monstre-icone.png\';"/>
		<a href="gestion_monstre.php" onclick="return envoiInfo(this.href, \'information\');montre(\'\');">G</a>
';
