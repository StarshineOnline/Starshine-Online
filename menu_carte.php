...
<?php
	echo '
		...
		<a href="javascript:envoiInfo(\'quete.php\', \'information\');montre(\'\');"><img src="image/icone/quete_icone.png" onmouseover="document.getElementById(\'image_quete\').src = \'image/icone/quete_icone_over.png\';" onmouseout="document.getElementById(\'image_quete\').src = \'image/icone/quete_icone.png\';" id="image_quete" alt="Quêtes" title="Quêtes" /></a>
