		...
		if($attaquant['hp'] > 0)
		{
			...
			if ($defenseur['hp'] <= 0)
			{
				if($ennemi == 'monstre')
				{
					...
					if($defenseur['ID'] == 64)
					{
						$requete = "INSERT INTO map_monstre VALUES('','65','3','212','4800', 6, '".addslashes('Le Fossoyeur')."','fossoyeur')"; 
						$db->query($requete);
					...
					if($defenseur['ID'] == 65)
					{
						$requete = "INSERT INTO map_monstre VALUES('','75','24','209','8000', 7, '".addslashes('Finrwirr le serviteur')."','finrwirr')"; 
						$db->query($requete);
					...
					if($defenseur['ID'] == 75)
					{
						$requete = "INSERT INTO map_monstre VALUES('','116','24','209','10000', 8, '".addslashes('Adenaïos le nécromant')."','adenaios')"; 
						$db->query($requete);
