...
if($W_distance == 0)
{
	...
	?>
		...
		<tr class="header trcolor2">
			...
			<td>
				<span onmousemove="afficheInfo('coef', 'block', event);" onmouseout="afficheInfo('coef', 'none', event );">Coéf.</span>
				<div style="display: none; z-index: 2; position: absolute; top: 250px; right: 150px; background-color:#ffffff; border: 1px solid #000000; font-size:12px; width: 300px; padding: 5px;" id="coef">
				<?php
					echo 'Coéf Arc = '.$joueur['coef_distance'].'<br />
					Coéf Mélée = '.$joueur['coef_melee'].'<br />
					Coéf Incantation = '.$joueur['coef_incantation'];
				?>
				</div>
			</td>
	<?php
	...
	?>
		...
		<tr class="element trcolor<?php echo $couleur; ?>">
			<td onmousemove="afficheInfo('info_<?php echo $row['id']; ?>', 'block', event);" onmouseout="afficheInfo('info_<?php echo $row['id']; ?>', 'none', event );">
				<?php echo $row['nom']; ?>
			</td>
			<td>
				<?php echo $row['type']; ?>
	...
	?>
		...
		<div style="display: none; z-index: 2; position: absolute; top: 250px; right: 150px; background-color:#ffffff; border: 1px solid #000000; font-size:12px; width: 300px; padding: 5px;" id="info_<?php echo $row['id']; ?>">
		<?php
...
<?php
	...
	?>
		...
		<div style="display: none; z-index: 2; position: absolute; top: 250px; right: 150px; background-color:#ffffff; border: 1px solid #000000; font-size:12px; width: 350px; padding: 5px;" id="info_<?php echo $row['id']; ?>">
		<?php
