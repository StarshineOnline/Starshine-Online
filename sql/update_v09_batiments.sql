...
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (14, "Protection physique détériorée", "debuff_pp", 20, 0, 3, "Diminue la PP de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (15, "Protection physique réduite", "debuff_pp", 40, 0, 3, "Diminue la PP de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (16, "Protection physique inférieure", "debuff_pp", 60, 0, 3, "Diminue la PP de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (17, "Protection physique excécrable", "debuff_pp", 80, 0, 3, "Diminue la PP de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (18, "Protection magique détériorée", "debuff_desespoir", 10, 0, 3, "Diminue la PM de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (19, "Protection magique réduite", "debuff_desespoir", 20, 0, 3, "Diminue la PM de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (20, "Protection magique inférieure", "debuff_desespoir", 30, 0, 3, "Diminue la PM de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (21, "Protection magique excécrable", "debuff_desespoir", 40, 0, 3, "Diminue la PM de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (22, "Évitement détériorée", "debuff_esquive", 10, 0, 3, "Diminue les chances d\'éviter les effets d\'une attaque physique de 1%effet%,.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (23, "Évitement réduite", "debuff_esquive", 20, 0, 3, "Diminue les chances d\'éviter les effets d\'une attaque physique de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (24, "Évitement inférieure", "debuff_esquive", 30, 0, 3, "Diminue les chances d\'éviter les effets d\'une attaque physique de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (25, "Évitement excécrable", "debuff_esquive", 40, 0, 3, "Diminue les chances d\'éviter les effets d\'une attaque physique de 1,%effet%.", 1);
...
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (30, "Production détériorée", "debuff_prod", 15, 0, 7, "Diminue la production de ressources de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (31, "Production réduite", "debuff_prod", 30, 0, 7, "Diminue la production de ressources de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (32, "Production inférieure", "debuff_prod", 45, 0, 7, "Diminue la production de ressources de 1,%effet%.", 1);
INSERT INTO buff_batiment_def (id, nom, type, effet, effet2, duree, description, debuff) VALUES (33, "Production excécrable", "debuff_prod", 60, 0, 7, "Diminue la production de ressources de 1,%effet%.", 1);
