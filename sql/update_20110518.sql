...
INSERT INTO `craft_recette` SELECT null id, 'Préparation de potion de protection magique' nom, 0 pa, 0 mp, 'protection' type, 50 difficulte, (SELECT concat('o', `id`, '-1') FROM `objet` WHERE `nom` = 'Potion de protection magique') resultat, 99999999 royaume_alchimie, 99999999 prix;
