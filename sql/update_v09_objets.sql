...
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Équerre", "petit", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 0, "architecture", 2, 1000, 2, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Équerre de qualité", "petit", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 12, "architecture", 3, 1000, 2, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Équerre parfait", "petit", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 16, "architecture", 5, 1000, 2, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Truelle", "moyen", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 0, "architecture", 5, 5000, 3, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Truelle de qualité", "moyen", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 12, "architecture", 10, 5000, 3, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Truelle parfait", "moyen", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 16, "architecture", 15, 5000, 3, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Maillet", "grand", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 0, "architecture", 10, 20000, 4, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Maillet de qualité", "grand", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 12, "architecture", 15, 20000, 4, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Maillet parfait", "grand", "Augmente les chances de réussir la réalisation une action d\'architecture de %effet%%.", 16, "architecture", 20, 20000, 4, 5);
...
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Petit saphir", "petit", "Augmente les points de mana maximaux de %effet%.", 0, "mp_max", 2, 300, 1, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Petit saphir polie", "petit", "Augmente les points de mana maximaux de %effet%.", 12, "mp_max", 3, 300, 1, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Petit saphir taillé", "petit", "Augmente les points de mana maximaux de %effet%.", 14, "mp_max", 5, 300, 1, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Saphir", "moyen", "Augmente les points de mana maximaux de %effet%.", 8, "mp_max", 5, 900, 3, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Saphir polie", "moyen", "Augmente les points de mana maximaux de %effet%.", 13, "mp_max", 15, 900, 3, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Saphir taillé", "moyen", "Augmente les points de mana maximaux de %effet%.", 17, "mp_max", 25, 900, 3, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Grand saphir", "grand", "Augmente les points de mana maximaux de %effet%.", 9, "mp_max", 15, 9000, 9, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Grand saphir polie", "grand", "Augmente les points de mana maximaux de %effet%.", 13, "mp_max", 25, 9000, 9, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Grand saphir taillé", "grand", "Augmente les points de mana maximaux de %effet%.", 16, "mp_max", 35, 9000, 9, 5);
...
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Verroterie", "petit", "Augmente les chances de dresser un humanoïde de %effet%%.", 7, "dressage_humanoide", 2, 700, 9, 5);
...
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Rations", "moyen", "Augmente les chances de dresser un humanoïde de %effet%%.", 0, "dressage_humanoide", 5, 4000, 1, 5);
...
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Rations parfaites", "moyen", "Augmente les chances de dresser un humanoïde de %effet%%.", 16, "dressage_humanoide", 10, 4000, 1, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Jouet", "grand", "Augmente les chances de dresser un humanoïde de %effet%%.", 7, "dressage_humanoide", 8, 15000, 9, 5);
INSERT INTO accessoire (nom, taille, description, puissance, type, effet, prix, lvl_batiment, encombrement) VALUES ("Jouet attrayant", "grand", "Augmente les chances de dresser un humanoïde de %effet%%.", 12, "dressage_humanoide", 12, 15000, 9, 5);
