...
UPDATE comp_combat SET description  = "Dégats normaux, pendant %duree% tours les chances de toucher et de lancer des sorts de l'adversaire sont réduits de %effet%%", effet = 10, effet2 = 0 WHERE id = 59;
UPDATE comp_combat SET description  = "Dégats normaux, pendant %duree% tours les chances de toucher et de lancer des sorts de l'adversaire sont réduits de %effet%%", effet = 15, effet2 = 0 WHERE id = 60;
UPDATE comp_combat SET description  = "Dégats normaux, pendant %duree% tours les chances de toucher et de lancer des sorts de l'adversaire sont réduits de %effet%%", effet = 20, effet2 = 0 WHERE id = 61;
UPDATE comp_combat SET description  = "Dégats normaux, pendant %duree% tours les chances de toucher et de lancer des sorts de l'adversaire sont réduits de %effet%%", effet = 25, effet2 = 0 WHERE id = 88;
UPDATE comp_combat SET description  = "Dégats normaux, pendant %duree% tours les chances de toucher et de lancer des sorts de l'adversaire sont réduits de %effet%%", effet = 30, effet2 = 0, duree = 3 WHERE id = 89;
