...
<fieldset>
	...
	<?php
	if(!$joueur->is_buff('repos_sage') OR !$joueur->is_buff('bloque_attaque')) echo '<a href="attaque.php?type=monstre&id_monstre='.$monstre['id'].'" onclick="return envoiInfo(this.href, \'information\')"><img src="image/interface/attaquer.png" alt="Combattre" title="Attaquer ('.($pa_attaque - $reduction_pa).' PA)" style="vertical-align : middle;" /> </a>';
