...
<fieldset>
	...
	echo ' <a href="dressage.php?id='.$W_ID.'" onclick="return envoiInfo(this.href, \'information\')"><img src="image/icone/miniconedressage.png" alt="Dressage" title="Dresser cette créature ('.($pa_attaque - $reduction_pa).' PA)" style="vertical-align : middle;" /></a>';	
