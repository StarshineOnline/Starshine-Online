...
if (array_key_exists('buff_rapidite', $joueur->get_buff())) $reduction_pa = $joueur->get_buff('buff_rapidite', 'effet'); else $reduction_pa = 0;
if (array_key_exists('debuff_ralentissement', $joueur->get_debuff())) $reduction_pa -= $joueur->get_debuff('debuff_ralentissement', 'effet);
...
$W_distance = detection_distance($W_case, convert_in_coord($joueur->get_x(), $joueur->get_y()));
if($W_distance < 4)
{
$case = new case($W_case);
?>
<fieldset>
