...
<?php if (isset($G_use_atmosphere) && $G_use_atmosphere) { ?>
					  <li><a href="meteo.php?action=atm&amp;effet=sky&amp;val=<?php echo $atm_val; ?>" onclick="return envoiInfo(this.href, 'meteo');"><?php echo $atm_verb; ?> les effets atmospheriques</a></li>
					  <li><a href="meteo.php?action=atm&amp;effet=time&amp;val=<?php echo $atm_all_val; ?>" onclick="return envoiInfo(this.href, 'meteo');"><?php echo $atm_all_verb; ?> les effets atmosphériques et liés à l'heure</a></li>
<?php } ?>
</ul>