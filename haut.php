...
else
{
	...
	elseif($interface_3D)
	{
		print_head("css:./css/texture3D.css~./css/texture_low.css~./css/interface3D.css;script:./javascript/jquery/jquery-1.4.min.js~./javascript/jquery/jquery-ui-1.7.2.custom.min.js~./javascript/fonction.js~./javascript/overlib/overlib.js;title:StarShine, le jeu qu'il tient ses plannings !");
	}
	elseif($admin)
	{
