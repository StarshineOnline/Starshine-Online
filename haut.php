...
if (isset($site) && $site)
{
	print_head("css:./css/site.css;script:./javascript/jquery/jquery-1.4.min.js~./javascript/jquery/jquery-ui-1.7.2.custom.min.js~./javascript/fonction.js~./javascript/site.js;title:StarShine, le jeu qu'il tient ses plannings !");
}
else
{
	if ($interface_v2)
	{
		print_head("css:./css/texture.css~./css/texture_low.css~./css/interfacev2.css;script:./javascript/jquery/jquery-1.4.min.js~./javascript/jquery/jquery-ui-1.7.2.custom.min.js~./javascript/fonction.js~./javascript/overlib/overlib.js;title:StarShine, le jeu qu'il tient ses plannings !");
	}
	elseif($interface_3D)
	{
		print_head("css:./css/texture3D.css~./css/interface3D.css~./css/prototip.css~./css/site.css;script:./javascript/fonction.js~./javascript/overlib/overlib.js~./javascript/jquery/jquery-1.4.min.js~./javascript/jquery/jquery-ui-1.7.2.custom.min.js;title:StarShine, le jeu qu'il tient ses plannings !");
	}
	elseif($admin)
	{
