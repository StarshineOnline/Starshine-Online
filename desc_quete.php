...
<div class="description_quete">
	...
	<a href="javascript:if(confirm('Voulez vous vraiment abandonner cette quète ?')) envoiInfo('quete.php?id_quete=<?php echo $_GET['id_quete']; ?>&amp;quete_joueur=<?php echo $_GET['quete_joueur']; ?>&amp;action=delete', 'information');">Abandonner cette quète</a>
</div>