...
<div style="font-size : 13px;">
	...
	<tr class="trcolor1">
		...
		<td>
			'.$joueur['PP'].' - Réduction des dégâts de '.(round(1 - calcul_pp($joueur['PP']), 4) * 100).' %
		</td>
	</tr>
	<tr class="trcolor2">
		<td>
	...
	<tr class="trcolor2">
		...
		<td>
			'.$joueur['PM'].' - Réduction des dégâts de '.(round(1 - calcul_pp($joueur['PM'] * $joueur['puissance'] / 12), 2) * 100).' %
		</td>
	</tr>
	<tr class="trcolor1">
		<td style="padding-right : 10px;">
